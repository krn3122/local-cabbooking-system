...
const { UserModel } = require("../../../Cab-Booking-website-group-project-2-icp-7-main/Backend/middlewares/model/user.model");
const { blacklistModel } = require("../../../Cab-Booking-website-group-project-2-icp-7-main/Backend/middlewares/model/blacklist");
const { RideRequestModel } = require("../../../Cab-Booking-website-group-project-2-icp-7-main/Backend/middlewares/model/riderequest.model");
const {
